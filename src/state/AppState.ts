...
class AppStateManager {
    ...
    constructor() {
        ...
        this._state = {
            ...
            terrainLayerStates,
            theme: document.documentElement.getAttribute('data-theme') ?? localStorage.getItem('dtm-theme') ?? 'blue',
            colorScheme: ((document.documentElement.getAttribute('data-color-scheme') ?? localStorage.getItem('dtm-color-scheme') ?? 'light') as 'light' | 'dark'),
            elevationRange: null,
            slopeUnit: 'degree',
